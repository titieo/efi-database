 ...
 *
 * Disassembly of DSDT.aml, Sun Jan 20 19:49:27 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001993D (104765)
 *     Revision         0x02
 *     Checksum         0x1E
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
     ...
     * disassembly, but only 23 were resolved (8 unresolved). Additional
    ...
    External (_SB_.PCI0.RP05.PEGP.ADVD, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.RP05.PEGP.DWBL, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.RP05.PEGP.GCDS, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.RP05.PEGP.LCDD._DCS, UnknownObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x9976F000, 0x035A)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x98A67F18, 0x10)
    ...
    Method (GUAM, 1, Serialized)
    {
        ...
        {
            Store (Arg0, DDPS)
            Store (LAnd (Arg0, LNot (\_SB.ACPF)), UAMS)
            If (Arg0)
            {
...
Else
{
    ...
    OperationRegion (ABNV, SystemMemory, 0x9975E000, 0x000D)

 ...
 *
 * Disassembly of SSDT-2-PegSsdt.aml, Fri Mar 20 04:26:39 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "PegSsd", "PegSsdt", 0x00001000)
{
    ...
    External (GCS4, IntObj)    // (from opcode)
    ...
    Scope (\_GPE)
    {
        ...
        Method (_L2E, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            Store (0x2E, P80H)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            If (\_OSI ("Linux-Dell-Video"))
            {
                If (LEqual (PION, Zero))
                {
                    If (LOr (LNotEqual (GPU1, Zero), LNotEqual (GPU2, Zero)))
                    {
                        Store (Zero, P0LD)
                    }

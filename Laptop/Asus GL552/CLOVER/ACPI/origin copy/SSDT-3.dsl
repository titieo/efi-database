 ...
 *
 * Disassembly of SSDT-3.aml, Sat Mar 28 18:24:27 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000066D0 (26320)
 *     Revision         0x02
 *     Checksum         0x4E
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x7707BD98, 0x0135)
        ...
        Method (GPPR, 2, NotSerialized)
        {
            ...
            ElseIf (LEqual (Arg1, One))
            {
                If (LEqual (Arg0, Zero))
                {
                    ...
                    Store (Zero, Local0)
                    While (LNotEqual (\_SB.GGIV (0x01020014), One))
                    {
                        Sleep (One)
                        Increment (Local0)

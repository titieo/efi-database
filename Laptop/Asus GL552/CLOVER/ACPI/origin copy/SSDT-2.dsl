 ...
 *
 * Disassembly of SSDT-2.aml, Sat Mar 28 18:24:27 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003DBE (15806)
 *     Revision         0x02
 *     Checksum         0xEC
 *     OEM ID           "DptfTa"
    ...
    Scope (\_SB.IETM)
    {
        ...
        Method (PSVT, 0, Serialized)
        {
            ...
            While (One)
            {
                ...
                {
                    If (LEqual (ToInteger (\_SB.SCWT), 0x01D6))
                    {
                        Return (PSV2)
                    }
                }
                ElseIf (LEqual (_T_0, 0x55))
                {
                    If (LEqual (ToInteger (\_SB.SCWT), 0x0122))
                    {
                        Return (PSV3)
                    }
                }

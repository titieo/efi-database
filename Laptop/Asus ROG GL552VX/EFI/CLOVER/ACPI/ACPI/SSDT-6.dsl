 ...
 *
 * Disassembly of SSDT-6.aml, Sat Mar 14 15:42:06 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001A3F (6719)
 *     Revision         0x01
 *     Checksum         0x11
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.ECPU, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC0_.RRAM, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC0_.ST8E, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC0_.WRAM, MethodObj)    // Warning: Unknown method, guessing 2 arguments
    External (_SB_.PCI0.P0LS, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.CEDR, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.DGCX, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.LNKD, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.LREN, IntObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.PEGP, DeviceObj)    // Warning: Unknown object
    External (_SB_.PCI0.PEG0.PEGP.LTRE, MethodObj)    // Warning: Unknown method, guessing 6 arguments
    External (_SB_.PCI0.PEG0.PEGP.SGST, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (_SB_.PCI0.PEG0.TDGC, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.SGPO, MethodObj)    // Warning: Unknown method, guessing 5 arguments
    ...
    External (SGGP, MethodObj)    // Warning: Unknown method, guessing 4 arguments
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6I >>>", Debug)
            Store (\_SB.PCI0.PEG0.LREN, \_SB.PCI0.PEG0.PEGP.LTRE (Store (\_SB.PCI0.LPCB.EC0.RRAM, 0x0521), Local0, And (Local0, 0xCF, Local0), \_SB.PCI0.LPCB.EC0.WRAM (0x0521, Local0), \_SB.PCI0.LPCB.EC0.WRAM (0x0520, 0x95), \_SB.PCI0.LPCB.EC0.WRAM (0x03A4, Zero)))
            \_SB.PCI0.LPCB.EC0.WRAM (0x03A5, Zero)
            Store (\_SB.PCI0.LPCB.EC0.RRAM, 0x045C)
            Local0
        ...
        {
            Store ("<<< GC6O >>>", Debug)
            While (LNotEqual (\_SB.GGIV, 0x01010015))
            {
                One
                Sleep (One)
            }
            ...
            \_SB.PCI0.SGPO (SGGP (Zero, 0x01010014, Zero, One), While (LNotEqual (\_SB.GGIV, 0x01010015))
                {
                    Zero
                    Sleep (One)
                }, \_SB.PCI0.SGPO (SGGP (Zero, 0x01010014, Zero, Zero), While (LLess (\_SB.PCI0.P0LS, 0x07))
                    {
                        Sleep (One)
                    }, Store (\_SB.PCI0.PEG0.PEGP.LTRE (\_SB.PCI0.PEG0.LREN, Store (One, \_SB.PCI0.PEG0.CEDR), \_SB.PCI0.LPCB.EC0.WRAM (0x052B, 0x9E), \_SB.PCI0.LPCB.EC0.WRAM (0x0520, 0x97), Store (\_SB.PCI0.LPCB.EC0.RRAM, 0x0521), Local0), And (Local0, 0xCF, Local0)), Or (Local0, 0x20, Local0), \_SB.PCI0.LPCB.EC0.WRAM (0x0521, Local0)), Store (\_SB.PCI0.LPCB.EC0.RRAM, 0x045C), Local0)
                ...
                Case (0x2A)
                {
                    ...
                    Switch (PSH0)
                    {
                        ...
                        Case (0x02)
                        {
                            Store (0x0102, RETN)
                            Store (Zero, VRV1)
                            Store (\_SB.PCI0.LPCB.EC0.ST8E, 0x23)
                            Zero
                            TGPU
                            Store (Zero, PDTS)
                            Store (Zero, SFAN)

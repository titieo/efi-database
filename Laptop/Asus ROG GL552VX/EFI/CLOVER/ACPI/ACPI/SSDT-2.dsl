 ...
 *
 * Disassembly of SSDT-2.aml, Sat Mar 14 15:42:06 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003DA6 (15782)
 *     Revision         0x02
 *     Checksum         0x4C
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (_PR_.PLW0, UnknownObj)    // Warning: Unknown object
    ...
    External (PPSZ, IntObj)    // Warning: Unknown object
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (CPL1, 0, NotSerialized)
        {
            ...
            Store (0x03E8, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x03))
            Store (0x03E8, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x04))
            Store (0x01F4, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x05))
            Store (One, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), Zero))
            Store (0x0DAC, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), One))
            Store (0xEA60, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x02))
            Store (0x03E8, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x03))
            Store (0x03E8, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x04))
            Store (0xFA, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x05))
        }

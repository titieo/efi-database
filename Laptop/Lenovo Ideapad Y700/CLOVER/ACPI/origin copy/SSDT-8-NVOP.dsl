 ...
 *
 * Disassembly of SSDT-8-NVOP.aml, Mon Feb 24 23:38:32 2020
 *
 ...
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20150818 (538249240)
 */
DefinitionBlock ("", "SSDT", 1, "Insyde", "NVOP    ", 0x00001000)
{
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x77F04018, 0x00040004)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x75F7DF98, 0x00000045)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (NOPR, SystemMemory, 0x77F6A018, 0x00002010)

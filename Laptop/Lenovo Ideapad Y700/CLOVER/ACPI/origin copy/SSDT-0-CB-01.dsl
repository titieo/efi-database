 ...
 *
 * Disassembly of SSDT-0-CB-01.aml, Mon Feb 24 23:38:32 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            {
                CreateDWordField (CRS, \_SB.TPM._Y36._BAS, CBAS)  // _BAS: Base Address
                Store (PTTB, CBAS)
                Store (PTTB, PTTA)
                Return (CRS)
            }
            ...
            OperationRegion (TNVS, SystemMemory, 0x77F65000, 0x27)

 ...
 *
 * Disassembly of DSDT.aml, Wed Feb 19 01:00:56 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001D650 (120400)
 *     Revision         0x02
 *     Checksum         0x43
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
{
    /*
     * iASL Warning: There were 61 external control methods found during
     * disassembly, but only 53 were resolved (8 unresolved). Additional
    ...
    External (PPMS, IntObj)    // Warning: Unknown object

 ...
 *
 * Disassembly of DSDT.aml, Sun Mar 29 02:59:06 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010B5B (68443)
 ...
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-GI   ", 0x00002250)
{
    ...
    External (_SB_.PCI0.VID_.STAT, FieldUnitObj)
    External (_SB_.PCI0.VID_.TCHE, FieldUnitObj)
    ...
    OperationRegion (MNVS, SystemMemory, 0xDCE7D018, 0x1000)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPC)
            {
                ...
                Device (MOU)
                {
                    ...
                    Method (MHID, 0, NotSerialized)
                    {
                        ...
                        {
                            Store (0x3500AE30, _HID)
                        }
                        Else
                        {
                            Store (0x3800AE30, _HID)
                        }
                    }
                }
                ...
                Device (VID)
                {
                    ...
                    Method (GPON, 1, NotSerialized)
                    {
                        If (ISOP ())
                        {
                            ...
                            ElseIf (LAnd (LNotEqual (VSID, 0x221417AA), LNotEqual (VSID, 0x221417AA)))
                            {
                                \VHYB (0x04, 0x00)
                            }
            ...
            Device (XHCI)
            {
                ...
                {
                    If (LNotEqual (\_SB.PCI0.XHCI.XHCV, 0xFFFF))
                    {
                        Store (0x01, \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.HP01, 0x01), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.HP02, 0x02), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.HP03, 0x03), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.HP07, 0x04), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.SP00, 0x05), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.SP01, 0x06), \USBC)
                        Or (\USBC, ShiftLeft (\_SB.PCI0.XHCI.SP02, 0x07), \USBC)
                    }
                }
                ...
                OperationRegion (XHCB, SystemMemory, Add (PEBS, 0x000A0000), 0x0100)
                ...
                {
                    If (LEqual (\_SB.PCI0.XHCI.DVID, 0xFFFF))
                    {
                        Return (Zero)
                    }

                    Store (0x00, Local6)
                    Store (\_SB.PCI0.XHCI.MBA1, Local7)
                    And (Local7, 0xFFFFFFF0, Local7)
                    If (LOr (LEqual (Local7, 0x00), LEqual (Local7, 0xFFFFFFF0)))
                    {
                        Store (0xFEAF0000, \_SB.PCI0.XHCI.MBA1)
                        Store (0x01, Local6)
                    }

                    Store (0x00, Local3)
                    Store (\_SB.PCI0.XHCI.PDBM, Local4)
                    If (LEqual (And (Local4, 0xFF), 0x00))
                    {
                        Store (\_SB.PCI0.XHCI.PDBM, Local0)
                        Or (Local0, 0x06, Local0)
                        Store (Local0, \_SB.PCI0.XHCI.PDBM)
                        Store (0x01, Local3)
                    }

                    Store (\_SB.PCI0.XHCI.MBA1, Local0)
                    ...
                    Store (0x00, \_SB.PCI0.XHCI.MB13)
                    Store (\_SB.PCI0.XHCI.D0D3, Local5)
                    And (Local5, 0x03, Local5)
                    If (LEqual (Local5, 0x03))
                    {
                        Store (\_SB.PCI0.XHCI.D0D3, Local5)
                        And (Local5, 0xFFFFFFFC, Local5)
                        Store (Local5, \_SB.PCI0.XHCI.D0D3)
                        Store (0x00, CLK0)
                        Store (0x00, CLK1)
                        Store (0x01, CLK2)
                        While (LOr (LOr (LEqual (P141, 0x02E0), LEqual (P142, 0x02E0)), LOr (LEqual (P143, 0x02E0), LEqual (P144, 0x02E0)))) {}
                        If (LEqual (P141, 0x02A0))
                        {
                            Store (0x01, WPR1)
                            While (LEqual (And (A171, 0x04), 0x00)) {}
                            Store (0x7F, A171)
                        }

                        If (LEqual (P142, 0x02A0))
                        {
                            Store (0x01, WPR2)
                            While (LEqual (And (A172, 0x04), 0x00)) {}
                            Store (0x7F, A172)
                        }

                        If (LEqual (P143, 0x02A0))
                        {
                            Store (0x01, WPR3)
                            While (LEqual (And (A173, 0x04), 0x00)) {}
                            Store (0x7F, A173)
                        }

                        If (LEqual (P144, 0x02A0))
                        {
                            Store (0x01, WPR4)
                            While (LEqual (And (A174, 0x04), 0x00)) {}
                            Store (0x7F, A174)
                        }
                    ...
                    {
                        Store (Local4, \_SB.PCI0.XHCI.PDBM)
                    }

                    If (LEqual (Local6, 0x01))
                    {
                        Store (Local7, \_SB.PCI0.XHCI.MBA1)
                    }
                }
                ...
                Method (_PS3, 0, Serialized)  // _PS3: Power State 3
                {
                    ...
                    Store (0x01, \_SB.PCI0.XHCI.PMES)
                    Store (0x01, \_SB.PCI0.XHCI.PMEE)
                    Store (0x00, Local1)
                    Store (\_SB.PCI0.XHCI.MBA1, Local2)
                    ...
                    Store (0x03, \_SB.PCI0.XHCI.MB13)
                    Store (\_SB.PCI0.XHCI.D0D3, Local0)
                    And (Local0, 0xFFFFFFFC, Local0)
                    Store (Local0, \_SB.PCI0.XHCI.D0D3)
                    Store (0x01, CLK0)
                    Store (0x01, CLK1)
                    Store (0x00, CLK2)
                    Store (0x00, AX15)
                    ...
                    {
                        Store (Local2, \_SB.PCI0.XHCI.MBA1)
                    }
                ...
                If (\VIGD)
                {
                    If (And (\_SB.PCI0.VID.TCHE, 0x0100))
                    {
                        If (And (\_SB.IAOE.GAOS, 0x01))
                        {
                            ...
                            {
                                Store (Or (And (\_SB.PCI0.VID.STAT, Not (0x03)), 0x01), \_SB.PCI0.VID.STAT)
